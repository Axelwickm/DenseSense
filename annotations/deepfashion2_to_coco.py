...
def main():
    ...
    for num in range(1,num_images+1):
        if num%100 == 0:
            print(num)
        json_name = './deepfashion2_annotations_'+dataset+'/' + str(num).zfill(6)+'.json'
        image_name = '../data/DeepFashion2/'+dataset+'/' + str(num).zfill(6)+'.jpg'
    ...
    json_name = './deepfashion2_'+dataset+'.json'
